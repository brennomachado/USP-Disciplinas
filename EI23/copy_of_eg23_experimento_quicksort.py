# -*- coding: utf-8 -*-
"""Copy of EG23 experimento quicksort

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DnyqBoNhS7adzejzYxGzRUbt8V9S_GCh
"""
...
'''
    ...
    - ordenação por inserção X quicksort recursivo 
    - ordenação por inserção X quicksort iterativo 
    - quisort recursivo      X quicksort iterativo 
...
# CARREGA as funções:
#     * ordene_por_insercao(),
#     * ordene_por_pivotacao() e
#     * ordene_por_pivotacaoI()
from eg_pivotacao import *

#-----------------------------------------------------------
# escolha os pares de funções a serem avaliadas
PARES_DE_FUNCOES = [
    [ ordene_por_insercao, ordene_por_pivotacao ],
    # [ ordene_por_insercao, ordene_por_pivotacaoI], 
    # [ ordene_por_pivotacao, ordene_por_pivotacaoI],
]
