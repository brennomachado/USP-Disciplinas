# -*- coding: utf-8 -*-
"""eg_npimagemEI13.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JHDF48A1RHUFBKS5CRWxqduqGhZGnkyl
"""
...
def main():
    ...
    print("####### TESTEs EG: ADD E MUL\n")

    print("Soma IMG 1 com 2,5")
    print(img1 + 2.5)

    print("Soma IMG 1 com 3")
    print(img1 + 3)

    print("Multiplica IMG 2 com 7")
    print(img2 * 7)

    print("Multiplica IMG 2 com 1,5")
    print(img2 * 1.5)


    print("####### TESTEs EG: BLEND\n")
    ...
    print("\n####### TESTEs EG: BLEND_ITERATIVO\n")
    img1 = NPImagem( (3,5), 10.0 )
    img2 = NPImagem( (3,5), 20.0 )
    img3 = img1.blend_iterativo(img2, 0.10)
    print(img3)
...
class NPImagem():
  ...
  # ---------------------------------------------------------------
    ...
    def blend_iterativo(self, other, alfa=0.5):
      ...
      data = (self * alfa).add_iterativo(other * (1-alfa))
