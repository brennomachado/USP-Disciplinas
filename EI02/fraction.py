...
def HFmaior( n ):
    ''' (int) -> Fraction
    Recebe um número inteiro "n" e retorna o harmonico simples para "n" calculado a partir do maior termo.
    '''

    harmonico = Fraction()
    for i in range(1, n+1, 1):
        harmonico = harmonico.some(Fraction(1,i))
...
def HFmenor( n ):
    ''' (int) -> Fraction
    Recebe um número inteiro "n" e retorna o harmonico simples para "n" calculado a partir do menor termo.
    '''
